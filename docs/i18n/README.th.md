...
`setup` จะตรวจหาเอเจนต์เขียนโค้ดของคุณ — **Claude Code**, **Codex**, **Cursor**,
**Copilot**, **Gemini CLI** และ **Aider** (พร้อมการส่งออกแบบ `generic` เป็น Markdown/JSON
และ **LLM ในเครื่อง** ที่เลือกใช้ได้) — แล้วติดตั้ง **การเชื่อมต่อแบบอ่านอย่างเดียว** ที่จำกัด
ขอบเขตเฉพาะโปรเจกต์ (`.mcp.json`, `.cursor/mcp.json`, `.codex/config.toml`,
`.vscode/mcp.json`, `.gemini/settings.json` หรือไฟล์บริบทของ Aider) พร้อมสำรองข้อมูล
ทุกอย่างที่มันแตะต้อง และตรวจสอบเซิร์ฟเวอร์ MCP แต่ละตัวด้วยการ handshake แบบสด
สัญญาฉบับเต็ม: **[docs/AGENT_INTEGRATION.md](../AGENT_INTEGRATION.md)**

**เซิร์ฟเวอร์ MCP** เป็นลูป stdio JSON-RPC แบบอ่านอย่างเดียว ที่ **ไม่มี MCP SDK** (เขียนขึ้นเอง) และมีเครื่องมือสี่ตัว:
...
ความเชื่อมั่น — ได้มาแบบเชิงกลไกในจุดที่สแกนเนอร์แนบมันได้ ทุกโหนดมี **ID ที่เสถียรและ
อ้างอิงตามเนื้อหา (content-addressable)** ดังนั้นกราฟจึงยังคงเทียบความต่าง (diffable) ได้
ข้ามการสแกนแต่ละครั้ง แบบจำลองเชิงลึก:
**[docs/GRAPH_MODEL.md](../GRAPH_MODEL.md)**

### Context Pack ตั้งแต่ต้นจนจบ
...
<div align="center">
<img src="../assets/studio-universe.webp" alt="KawnGraph Studio — มุมมอง 'Universe' แบบ 3D อ่านอย่างเดียวของกราฟรีโพซิทอรีนี้เอง: 1,261 โหนดที่จัดกลุ่มตามชั้น (Code 815, Docs 430, Config 13, Data 3) พร้อมเส้นเชื่อมต่อ และตัวกรองตามชั้น/ชนิด/เส้นเชื่อม" width="860">
<br><sub>มุมมอง <b>Universe</b> แบบ 3D — กราฟของรีโพซิทอรีนี้เอง (1,261 โหนด) แบบอ่านอย่างเดียว</sub>
</div>

<div align="center">
<img src="../assets/studio-map.webp" alt="KawnGraph Studio — มุมมองกราฟ 2D ของโปรเจกต์ตัวอย่างที่แนบมา: ไฟล์ ฟังก์ชัน route ตาราง และเอกสารเป็นโหนด พร้อมเส้นเชื่อมที่มีหลักฐานรองรับและมีป้ายกำกับ (imports, calls, defines, mentions, explains) และตัวกรองตามชั้น/ชนิด/เส้นเชื่อม" width="860">
<br><sub>มุมมอง <b>กราฟ</b> 2D — โปรเจกต์ตัวอย่างที่แนบมา พร้อมตัวกรองตามชั้น / ชนิด / เส้นเชื่อม</sub>
</div>
...
เอเจนต์ด้วยคำสั่งเดียว (Claude Code, Codex, Cursor, Copilot, Gemini, Aider, การส่งออกแบบ
generic, LLM ในเครื่อง), Studio และฮาร์เนสเบนช์มาร์ก A/B
...
สร้างและดูแลโดย **[Abdulrahman Alnashri](https://www.linkedin.com/in/abdulrahman-alnashri-ai/)**
