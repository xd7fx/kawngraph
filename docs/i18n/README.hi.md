...
<div align="center">
<img src="../assets/context-pack-flow.svg" alt="एक टास्क ('Zid OAuth callback ठीक करो') KawnGraph में जाता है, जो एक टोकन-बजटेड Context Pack लौटाता है: पढ़ने योग्य ज़रूरी फाइलें, संबंधित डॉक्स, टेबल, टेस्ट, जोखिम, एक बहिष्कृत सूची, और एक कॉन्फिडेंस स्कोर।" width="860">
</div>
...
> **एजेंट्स को नक्शा दो, पूरा रिपॉज़िटरी नहीं।**

---

## शुरुआत करें

KawnGraph को **एक ही कमांड** से इंस्टॉल और चलाएँ — `npx` इसे फ़ेच करता है, क्लोन
करने की ज़रूरत नहीं (Node ≥ 18):
...
**या सोर्स से** (यह monorepo, योगदानकर्ताओं के लिए — [pnpm](https://pnpm.io)):
...
`setup` आपके कोडिंग एजेंट्स का पता लगाता है — **Claude Code**, **Codex**, **Cursor**,
**Copilot**, **Gemini CLI**, और **Aider** (साथ ही एक `generic` Markdown/JSON एक्सपोर्ट
और एक वैकल्पिक **local LLM**) — और प्रोजेक्ट तक सीमित एक **read-only integration**
स्थापित करता है (`.mcp.json`, `.cursor/mcp.json`, `.codex/config.toml`,
`.vscode/mcp.json`, `.gemini/settings.json`, या एक Aider context फाइल), जिसे वह छूता
है उसका बैकअप लेता है और प्रत्येक MCP server को एक लाइव handshake के साथ सत्यापित
करता है। पूर्ण अनुबंध: **[docs/AGENT_INTEGRATION.md](../AGENT_INTEGRATION.md)**।

**MCP server** एक read-only stdio JSON-RPC लूप है जिसमें **कोई MCP SDK नहीं** है
(हाथ से बनाया गया) और चार टूल हैं:
...
<div align="center">
<img src="../assets/architecture.svg" alt="KawnGraph आपकी रिपॉज़िटरी को डिटरमिनिस्टिक स्कैनर्स के साथ पढ़कर .kawn/graph.json पर एक परतदार ग्राफ़ (code, data, config, docs, test परतें) बनाता है, जो kawn CLI, MCP server, और Studio को read-only परोसा जाता है। कोई नेटवर्क नहीं, कोई LLM नहीं, कोई टेलीमेट्री नहीं।" width="860">
</div>
...
रखता है — जहाँ स्कैनर उसे संलग्न कर सकता है वहाँ यंत्रवत् रूप से व्युत्पन्न; प्रत्येक
node के पास एक **stable, content-addressable ID** होती है ताकि ग्राफ़ स्कैन-दर-स्कैन
diffable बना रहे। गहरा मॉडल:
**[docs/GRAPH_MODEL.md](../GRAPH_MODEL.md)**।

### एक Context Pack, शुरू से अंत तक
...
<div align="center">
<img src="../assets/studio-universe.webp" alt="KawnGraph Studio — इस रिपॉज़िटरी के अपने ग्राफ़ का read-only 3D 'Universe' व्यू: परत के अनुसार क्लस्टर किए गए 1,261 nodes (Code 815, Docs 430, Config 13, Data 3) कनेक्शन लाइनों के साथ, साथ ही प्रति-परत/प्रकार/edge फिल्टर।" width="860">
<br><sub>3D <b>Universe</b> व्यू — इस रिपॉज़िटरी का अपना ग्राफ़ (1,261 nodes), read-only।</sub>
</div>

<div align="center">
<img src="../assets/studio-map.webp" alt="KawnGraph Studio — बंडल किए गए उदाहरण प्रोजेक्ट का 2D ग्राफ़ व्यू: फाइलें, functions, routes, tables, और डॉक्स nodes के रूप में, लेबल किए गए साक्ष्य-समर्थित edges (imports, calls, defines, mentions, explains) के साथ, साथ ही परत/प्रकार/edge फिल्टर।" width="860">
<br><sub>2D <b>graph</b> व्यू — बंडल किया गया उदाहरण प्रोजेक्ट, परत / प्रकार / edge फिल्टर के साथ।</sub>
</div>
...
- **डिफ़ॉल्ट रूप से कोई नेटवर्क नहीं।** स्कैन और रिट्रीवल आपकी रिपॉज़िटरी को पढ़ते हैं
...
Studio, और A/B benchmark harness।
...
निर्माण और रखरखाव **[Abdulrahman Alnashri](https://www.linkedin.com/in/abdulrahman-alnashri-ai/)** द्वारा।
