...
Instale e execute o KawnGraph com **um único comando** — o `npx` o baixa, sem nada
para clonar (Node ≥ 18):
...
**Ou a partir do código-fonte** (este monorepo, para contribuidores — [pnpm](https://pnpm.io)):
