...
Installa ed esegui KawnGraph con **un solo comando** — `npx` lo recupera, niente
da clonare (Node ≥ 18):
...
**Oppure da codice sorgente** (questo monorepo, per chi contribuisce — [pnpm](https://pnpm.io)):
